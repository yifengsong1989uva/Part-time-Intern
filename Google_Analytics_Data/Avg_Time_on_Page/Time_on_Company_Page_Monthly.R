...
mydata <- read.csv(paste0("Monthly_Avg_Time_on_Company_Page/",args[1]))
...
write.csv(mydata4,file=paste0("Monthly_Avg_Time_on_Company_Page/Average_Time_on_Company_Page--",args[1]),
          row.names=F)